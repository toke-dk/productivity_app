...
class ShowAmountGoal extends StatelessWidget {
  const ShowAmountGoal(
      {super.key,
      required this.goal,
  ...
  Widget build(BuildContext context) {
    ...
    List<DoneAmountActivity> _doneActivitiesInPast = _currentGoal
        .doneAmountActivities
        .where((element) =>
            element.date.onlyYearMonthDay.isBefore(currentDay.onlyYearMonthDay))
        .toList();
            ...
            ? Column(
                ...
                children: [
                  ...
                  LinearPercentIndicator(
                      ...
                      leading:
                          _MyAnimatedPercent(val: (_percentForToday * 100))),
                  Row(
                    children: [
                      _amountLeftToday > 0
                          ? AnimatedDigitWidget(
        ...
        Text(
          _currentGoal.frequencyFormat == GoalFrequencyFormats.inTotal
              ...
              : _currentGoal.frequencyFormat == GoalFrequencyFormats.perWeek
                  ? "Ugens mål"
                  : _currentGoal.frequencyFormat == GoalFrequencyFormats.perDay
                      ? "Dagens mål"
                      : "FEJL!!",
          style: Theme.of(context).textTheme.bodyLarge,
        ),
